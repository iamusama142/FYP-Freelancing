                ...
                <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
                    <div class="card card-primary" style="margin-top: 100px;">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="/sendrateteam/{{$value->id}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                @endif
                                    ...
                                    @if ($value->reciever_id == session()->get('USER_id'))
                                        ...
                                        <span class='result'
                                            style="font-size: 20px; color:black; margin-left:7px;" required>0</span>
                                        <input type="hidden" name="rating">

                                        <div class="mt-3">
                                            <label for="">Select Your Payment Method</label>

                                            <select class="form-control" required   id="ddlPassport" name="payment" value="{{ old('role') }}"
                                                >
                                        ...
                                        margin-bottom: 15px;display:none;" id="dvPassport">
                                             <label for="">Enter TID No</label>
                                             <input type="text" class="form-control" name="tid">
                                             <label for="">Enter Amount </label>

                                             <input type="text" class="form-control" placeholder="Enter Amount For Send" name="amount">
